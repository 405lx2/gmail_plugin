...
public class BCS {
    ...
    public void putObjectByFile(String filename,File f) {
	PutObjectRequest request = new PutObjectRequest(bucket, '/'+filename,f );
    ...
    public void download(List<memfile> l,mysql sql) throws FileNotFoundException,
	...
	return getObjectWithInputstream(filename).getContent();
    }

    public DownloadObject getObjectWithInputstream(String object) {
