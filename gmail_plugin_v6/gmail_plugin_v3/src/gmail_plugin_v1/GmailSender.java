...
public class GmailSender {
    ...
    private void addAttachment(Multipart multipart, uploadfile file)
	    throws MessagingException, IOException {
	MimeBodyPart messageBodyPart = new MimeBodyPart();
	ByteArrayDataSource ds = new ByteArrayDataSource(file.file,
    ...
    public void send(String address, String subject, String text,
	    List<uploadfile> files) throws IOException {
